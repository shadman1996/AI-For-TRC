...
def test_kb_api():
    ...
    print(f"Token obtained successfully! appId: {conn.appid}")
    headers = {
    ...
    url_search = f"{conn.base_url}/{conn.appid}/kb/search"
    payload = {
        "MaxResults": 200,
        "Status": 1 # Active articles
    }
    ...
    url_list = f"{conn.base_url}/{conn.appid}/kb"
